            ...
            <div className='bg-white p-6 rounded-lg shadow-md' style={{ maxWidth: '800px', margin: '10px auto', padding: '20px', borderRadius: '10px', boxShadow: '0 4px 20px rgba(0, 0, 0, 0.1)' }}>
                <form onSubmit={handleSubmit} onReset={handleReset}>
                    ...
                    <div className='flex justify-end gap-4 mt-4'>
                        ...
                        <button type="submit" disabled={loading || !isChecked} className={`px-4 py-2 rounded ${loading || !isChecked ? 'bg-gray-400' : 'bg-green-600 text-white'}`} style={{ cursor: 'pointer', padding: '10px 20px', }}>
