...
export const HostelAdminStudents = () => {
                ...
                <div className="overfolow-x-auto max-w-full">
                    <div >
                        <DataTable
                            ...
                            responsive
                            pointerOnHover
                            onRowClicked={(row) => navigate(`/staff-dashboard/students/view/${row._id}`)}
    ...
    <section className="max-w-4xl mx-auto bg-white shadow-lg rounded-xl p-6 mt-8"
      ...
      <div className="flex flex-col sm:flex-row gap-4 mt-8"
        ...
        <button
          ...
          onClick={() => navigate(`/staff-dashboard/exeats/by-student/${student._id}`)}
